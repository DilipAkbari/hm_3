...
public class SignInPage extends HomePage {
    ...
    public void verifySignInPageText(String pgTxt) {
        Reporter.log(" Verify text dispalyed: " + pgTxt + " on sign in page " + _pageText.toString() + "<br>");
        verifyTextAssertMethod(_pageText, pgTxt);
        log.info(" Verify text dispalyed: " + pgTxt + " on sign in page " + _pageText.toString());
    }

    public void verifyErrorMessage(String errMsg) {
        Reporter.log(" Verify error message: " + errMsg + " displayed" + _errorMessage.toString() + "<br>");
        verifyTextAssertMethod(_errorMessage, errMsg);
        log.info(" Verify error message: " + errMsg + " displayed" + _errorMessage.toString());
    }
