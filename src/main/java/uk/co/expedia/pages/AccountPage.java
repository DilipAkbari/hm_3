...
public class AccountPage extends Utility {
    private static final Logger log = Logger.getLogger(AccountPage.class.getName());
    ...
    public void mouseHoverOnSignInBtn() {
        ...
        getTextFromElement(_signInBtn);
        log.info(" Mouse hover on sign in button: " + _signInBtn.toString());
    }

    public void verifyAccountPageText(String pgTxt) {
        Reporter.log(" Verify text displayed: " + pgTxt + " on account page " + _pageText.toString() + "<br>");
        verifyTextAssertMethod(_pageText, pgTxt);
        log.info(" Verify text displayed: " + pgTxt + " on account page " + _pageText.toString());
    }
